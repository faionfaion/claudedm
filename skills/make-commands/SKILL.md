...
**Communication with user: Ukrainian. Command content: English.**
...
**Trigger phrases:** "create command", "edit command", "change command", "update command", "modify command", "fix command", "/command", "slash command", "зміни команду", "оновити команду", "додай до команди"
